...
![Codex Reset Credit Manager window showing automatic use enabled and a scheduled reset credit](docs/images/manager-ui-example-01.png)

*Actual Codex Reset Credit Manager window.*
